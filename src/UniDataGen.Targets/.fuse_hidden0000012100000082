...
/// <summary>
/// Writes generated batches to Azure Data Lake Storage Gen2 as partitioned newline-delimited JSON.
/// Authentication and container handling come from <see cref="AdlsUploader"/>; this sink owns the
/// NDJSON serialization and the partition path.
/// </summary>
public sealed class AdlsGen2Sink : ISink
{
    private readonly AdlsUploader _uploader;
    private readonly string? _baseDirectory;

    public AdlsGen2Sink(TargetConfig config, ILogger? logger = null)
    {
